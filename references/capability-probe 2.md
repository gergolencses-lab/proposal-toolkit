...
Az `init` ezzel tölti ki a `house-style.md` `render_chain` slotjait (`primary`, `critique`, `to_pdf`).
A slotok jelentése és a hiányuk következménye: `{pluginRoot}/references/company-config.md`.
